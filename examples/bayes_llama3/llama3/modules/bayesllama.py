...
class BayesLlamaModel(LlamaModel):
    ...
    def forward(
        ...
        if use_cache:
            ...
            # We create a separate KV cache for the final attention layer
            # The KV cache is necessary since we now have n last layers which would not work properly with the regular kv cache
            ensemble_next_cache = [
